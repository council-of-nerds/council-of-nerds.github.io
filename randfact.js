...
if (fact == 0) {
	...
	document.getElementById("fact").innerHTML = "Water Temperature:- Ideal Range: 78°F to 84°F (25°C to 29°C) Most people find water within this temperature range to be comfortable for swimming. However, personal preferences can vary.";
}else if(fact==3) {
